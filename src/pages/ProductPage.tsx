  ...
  return (
    <>
      ...
      <div className="container flex flex-col w-[90%] p-6 mx-auto rounded-md">
        ...
        {product?.reviews ? product?.reviews?.map((el: any) => {
          return <div className="border rounded border-black mb-3">
            <div className="flex justify-between p-4">
              <div className="flex space-x-4">
                ...
                <div>
                  <h4 className="font-bold">{el?.user[0]?.first_name + " " + el?.user[0]?.last_name}</h4>
